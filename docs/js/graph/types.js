const GraphTypes = {
  ASR: {
    ...
    schema: [
      ...
      { key: 'service', label: 'Service Alias', type: 'text', placeholder: 'whisper_asr' },
      { key: 'endpointSource', label: 'Endpoint Source', type: 'select', options: ['router', 'manual'], def: 'router' },
  ...
  LLM: {
    ...
    schema: [
      ...
      { key: 'relay', label: 'NKN Relay', type: 'text' },
      { key: 'service', label: 'Service Alias', type: 'text', placeholder: 'ollama_farm' },
      { key: 'endpointSource', label: 'Endpoint Source', type: 'select', options: ['router', 'manual'], def: 'router' },
      { key: 'endpointMode', label: 'Endpoint Mode', type: 'select', options: ['auto', 'local', 'remote'], def: 'auto' },
      { key: 'api', label: 'API Key', type: 'text' },
      { key: 'model', label: 'Model', type: 'select', options: [] },
  ...
  TTS: {
    ...
    schema: [
      ...
      { key: 'relay', label: 'NKN Relay', type: 'text' },
      { key: 'service', label: 'Service Alias', type: 'text', placeholder: 'piper_tts' },
      { key: 'endpointSource', label: 'Endpoint Source', type: 'select', options: ['router', 'manual'], def: 'router' },
      { key: 'endpointMode', label: 'Endpoint Mode', type: 'select', options: ['auto', 'local', 'remote'], def: 'auto' },
      { key: 'api', label: 'API Key', type: 'text' },
  ...
  NoClipBridge: {
    ...
    schema: [
      ...
      { key: 'marketPublishScope', label: 'Market Publish Scope', type: 'select', options: ['both', 'broadcast', 'targeted'], def: 'both' },
      { key: 'marketPublishIncludeStatus', label: 'Publish Market Status', type: 'select', options: ['true', 'false'], def: 'true' },
      { key: 'marketBroadcastRoom', label: 'Market Broadcast Room', type: 'text', placeholder: '(auto)', def: 'auto' },
      { key: 'marketCatalogSubject', label: 'Market Catalog Subject', type: 'text', placeholder: 'hydra.market.catalog.v1', def: 'hydra.market.catalog.v1' },
      { key: 'marketStatusSubject', label: 'Market Status Subject', type: 'text', placeholder: 'hydra.market.status.v1', def: 'hydra.market.status.v1' },
      { key: 'marketBroadcastPublicOnly', label: 'Broadcast Public Offers Only', type: 'select', options: ['true', 'false'], def: 'true' },
  ...
  Pointcloud: {
    ...
    schema: [
      ...
      { key: 'relay', label: 'NKN Relay', type: 'text' },
      { key: 'service', label: 'Service Alias', type: 'text', placeholder: 'depth_any', def: 'depth_any' },
      { key: 'endpointSource', label: 'Endpoint Source', type: 'select', options: ['router', 'manual'], def: 'router' },
      { key: 'endpointMode', label: 'Endpoint Mode', type: 'select', options: ['auto', 'local', 'remote'], def: 'auto' },
  ...
  MCP: {
    ...
    schema: [
      ...
      { key: 'relay', label: 'NKN Relay', type: 'text' },
      { key: 'service', label: 'Service Alias', type: 'text', placeholder: 'mcp_server' },
      { key: 'endpointSource', label: 'Endpoint Source', type: 'select', options: ['router', 'manual'], def: 'router' },
      { key: 'endpointMode', label: 'Endpoint Mode', type: 'select', options: ['auto', 'local', 'remote'], def: 'auto' },
      { key: 'api', label: 'API Key', type: 'text' },
      { key: 'autoConnect', label: 'Auto Connect', type: 'select', options: ['true', 'false'], def: 'true' },
